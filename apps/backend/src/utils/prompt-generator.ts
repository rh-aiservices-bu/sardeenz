...
const SAMPLE_WORDS = [
  'analyze', 'explain', 'describe', 'compare', 'evaluate', 'discuss', 'consider',
  'the', 'a', 'an', 'of', 'in', 'to', 'for', 'with', 'on', 'at', 'by', 'from',
  'this', 'that', 'these', 'those', 'what', 'which', 'how', 'why', 'when', 'where',
  'system', 'process', 'method', 'approach', 'technique', 'strategy', 'framework',
  'data', 'information', 'knowledge', 'understanding', 'insight', 'perspective',
  'important', 'significant', 'relevant', 'essential', 'critical', 'fundamental',
  'development', 'implementation', 'optimization', 'integration', 'transformation',
  'performance', 'efficiency', 'effectiveness', 'productivity', 'scalability',
  'learning', 'training', 'model', 'algorithm', 'network', 'architecture',
  'application', 'solution', 'problem', 'challenge', 'opportunity', 'outcome',
  'business', 'technology', 'innovation', 'research', 'analysis', 'evaluation',
  'quality', 'improvement', 'enhancement', 'advancement', 'progress', 'success',
  'context', 'environment', 'situation', 'scenario', 'condition', 'circumstance',
  'relationship', 'connection', 'interaction', 'communication', 'collaboration',
  'decision', 'action', 'result', 'impact', 'effect', 'consequence', 'benefit',
  'resource', 'capability', 'capacity', 'potential', 'possibility', 'option',
  'structure', 'organization', 'pattern', 'trend', 'behavior', 'characteristic',
  'based', 'related', 'associated', 'connected', 'linked', 'integrated', 'combined',
  'various', 'different', 'multiple', 'several', 'numerous', 'diverse', 'specific',
  'can', 'may', 'might', 'could', 'would', 'should', 'must', 'will', 'shall',
  'provide', 'offer', 'deliver', 'create', 'generate', 'produce', 'develop',
  'support', 'enable', 'facilitate', 'enhance', 'improve', 'optimize', 'maximize',
]
...
const VERBS = [
  'analyze', 'explain', 'describe', 'evaluate', 'discuss', 'consider',
  'examine', 'investigate', 'explore', 'review', 'assess', 'outline',
]

const NOUNS = [
  'system', 'process', 'method', 'approach', 'technique', 'strategy',
  'framework', 'model', 'algorithm', 'architecture', 'solution', 'concept',
  'implementation', 'development', 'optimization', 'integration', 'analysis',
]

const ADJECTIVES = [
  'important', 'significant', 'relevant', 'essential', 'critical', 'fundamental',
  'complex', 'sophisticated', 'advanced', 'innovative', 'practical', 'effective',
]
